                ...
                @for ($j = $i; $j < $i + 4 && $j < $itemCount; $j++)
                    <li>
                        @if(count($navitem[$j]['children']))
                            <a href="javascript:void(0)" class="hover:underline hover:text-blue-600 dark:hover:text-blue-500"
                            ...
                            <ul id="mega-child-{{$navitem[$j]['slug']}}" class="hidden">
                                ...
                                <li class="mb-1 mt-1 ml-4">
                                    <a href="{{$navmegachild['link']}}"
                                        class="hover:underline hover:text-blue-600 dark:hover:text-blue-500 m-2" wire:navigate>
                                        {{$navmegachild['name']}}
                                    </a>
                                </li>
                                @endforeach
                        ...
                        @else
                            <a href="{{ $navitem[$j]['link'] }}" class="hover:cursor-pointer hover:underline hover:text-blue-600 dark:hover:text-blue-500" wire:navigate>{{ $navitem[$j]['name'] }}</a>
                        @endif
                    </li>
                @endfor
            </ul>
