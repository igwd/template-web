<li x-data="{ megaMenuOpen: false }" class="flex items-center" x-bind:key="navbar.name">
    <template x-if="navbar.children.length">
        <a href="javascript:void(0)"
        x-on:click="toggleChildComponent('mega-'+navbar.slug)"
    ...
    <template x-if="!navbar.children.length">
        ...
        x-text="navbar.name" wire:navigate>
        </a>    
    </template>
    <script>
