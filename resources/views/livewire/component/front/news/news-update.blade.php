<div
    class="w-1/2 h-full flex flex-col p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <div class="flex items-center ">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm hover:text-purple-600 font-medium text-gray-900  dark:text-white">
                            <a href="http://" target="_blank" rel="noopener noreferrer">Penyerahan Ijin Program Studi
                                Program Profesi Insinyur (PS.PPI) Universitas Warmadewa</a>
                        </p>
            ...
            <li class="py-3 sm:py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm hover:text-purple-600 font-medium text-gray-900 dark:text-white">
                            <a href="http://" target="_blank" rel="noopener noreferrer">Evaluasi Lapangan Program
                                Profesi Insinyur (PPI) FTP Unwar</a>
                        </p>
                        <span class=" text-xs text-gray-500 truncate dark:text-gray-400">
                            1 Juni 2023
                        </span>
    ...
    <div class="flex mt-auto justify-center items-center">
        <!-- Previous Button -->
        <a href="#"
