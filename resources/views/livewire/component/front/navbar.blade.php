    ...
    <nav class="bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-900 fixed z-50 w-full shadow-md">
        ...
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
            ...
            <button data-collapse-toggle="mega-menu-full-image" type="button"
                class=" bg-gray-300 inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                ...
                <ul class="flex flex-col mt-4 font-medium md:flex-row md:space-x-8 md:mt-0">
                    ...
                    <li class="flex items-center">
                        <button id="mega-menu-full-cta-image-button"
                            ...
                            Kami <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
