    ...
    <nav class="bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-900 fixed z-50 w-full shadow-md">
        ...
        <div class="flex flex-wrap items-center mx-auto max-w-screen-xl pt-4 pl-4 pr-4 w-full">
            <a href="https://www.teknik.warmadewa.ac.id/" class="flex items-center ">
                ...
                <span
                    class="self-center sm:text-base md:text-lg font-semibold whitespace-nowrap dark:text-white ">Fakultas
                    Teknik dan
                    Perencanaan</span>
                    ...
                    <ul class="flex flex-col mt-4 font-medium md:flex-row md:space-x-8 md:mt-0">
                        ...
                        <li class="flex items-center">
                            <button id="mega-menu-full-cta-image-button"
                                ...
                                Kami <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true"
                        ...
                        <li class="flex items-center">
                            <a href="#"
                                class="block py-2 pl-3 pr-4 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Akademik</a>
                        </li>
                        <li class="flex items-center">
                            <a href="#"
                                class="block py-2 pl-3 pr-4 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Kemahasiswaan</a>
                        </li>
                        <li class="flex items-center">
                            <a href="#"
                                class="block py-2 pl-3 pr-4 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Tri
                                Darma</a>
                        </li>
                        <li class="flex items-center">
                            <a href="#"
                                class="block py-2 pl-3 pr-4 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Layanan</a>
                        </li>
                        <li class="flex items-center">
                            <a href="#"
                                class="block py-2 pl-3 pr-4 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Unduh</a>
                        </li>
                        <li class="flex items-center">
                            <a href="#"
                                class="block py-2 pl-3 pr-4 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Kontak</a>
                        </li>
        ...
        <div id="mega-menu-full-image-dropdown"
            class=" hidden w-full bg-white border-gray-200 shadow-sm border-y dark:bg-gray-800 dark:border-gray-600 absolute z-50">
            <div
                class="grid max-h-64 overflow-y-auto md:overflow-hidden md:max-w-screen-xl px-4 py-5 mx-auto text-sm text-gray-500 dark:text-gray-400 md:grid-cols-3 md:px-6">
