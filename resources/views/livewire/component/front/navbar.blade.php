<div>
    <nav class="bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-900 fixed z-40 w-full shadow-md">
        <div class="flex flex-wrap items-center mx-auto max-w-screen-xl pt-4 pl-4 pr-4 w-full">
            ...
            <a href="{{ url('/') }}" class="flex items-center ">
                ...
                <span
                    ...
                    <span class="flex self-center text-sm whitespace-nowrap dark:text-white ">{{ $site['sub_header'] }}
                    </span>
                </span>
            </a>
