...
<section
    ...
    <div class="w-3/5 h-full grid grid-cols-2 items-center justify-center bt">
        <div
            ...
            <svg class="w-10 mr-2" fill="currentColor" viewBox="0 0 32 32" enable-background="new 0 0 32 32" id="Layer_3"
        ...
        <div
            ...
            <svg class="w-7 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                <g id="SVGRepo_iconCarrier">
                    <circle cx="16" cy="8" r="2" stroke="currentColor" stroke-width="1.5"></circle>
                    <path
