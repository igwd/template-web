                    ...
                    @if ($carousels[$item]['bgvideo'])
                        <div class=" relative bg-bg-dark text-white ">
                            <video class="absolute object-cover w-full h-full scale-125" autoplay loop muted>
                                <source src="{{ Storage::disk('carousel')->url($carousels[$item]['bgvideo']) }}"
                                    type="video/mp4">
                            </video>
                            <div class="p-20 z-30 flex-col justify-center items-center flex" data-aos="fade-up"
                                ...
                                <p
                                    class="custom-shadow text-4xl md:text-6xl md:mb-4 md:mt-4 text-yellow-300 font-lobster">
                    ...
                    @else
                        <div class="grid grid-rows-2 md:grid-cols-2 text-white text-5xl text-center ">
                            <div class=" flex-col p-6 md:justify-center items-center flex" data-aos="fade-up"
                                ...
                                <p class="hidden md:block mt-20 text-lg font-poppins">
                                    {{ $carousels[$item]['description'] }}</p>
                                <ul
                            ...
                            <div class="">
                                <img src="{{ Storage::disk('carousel')->url($carousels[$item]['bgimage']) }}"
                                    alt="" srcset="" class="h-full object-cover object-center">
                            </div>
                        </div>
                    @endif
                    <a @click="scrollToDiv('info')" class="justify-center items-center flex cursor-pointer">
