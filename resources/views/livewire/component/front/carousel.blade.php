                ...
                <div class="flex h-full w-full text-white text-5xl text-center ">
                    <div class="w-1/2 flex-col p-6 justify-center items-center flex" data-aos="fade-up"
                        ...
                        <ul
                            ...
                            <li class="text-gray-200 hover:text-blue-500 transition cursor-pointer text-xl">Arsitektur
                            </li>
                            <li class="text-gray-200 hover:text-blue-500 transition cursor-pointer text-xl">Teknik
                                Komputer
                            </li>
                        </ul>
                    </div>
                ...
                <div class="flex h-full w-full text-white text-5xl text-center ">
                    <div class="w-1/2 flex-col p-6 justify-center items-center flex">
                        ...
                        <p class="mt-14 text-lg font-poppins">Technopreneur adalah seorang individu atau wirausaha yang
                            ...
                            peluang bisnis di dalam dunia teknologi dan menciptakan produk atau layanan berbasis
                            teknologi
            ...
            <div class="carousel-item absolute opacity-0">
                <div class="flex h-full w-full text-white text-5xl text-center ">
                    <div class="w-1/2 flex-col p-6 justify-center items-center flex">
                        ...
                        <p class="mt-14 text-lg font-poppins">Berwawasan ekowisata adalah konsep pengembangan yang
                            berfokus
                            pada upaya melestarikan alam dan budaya setempat sambil tetap memungkinkan aktivitas
                            pariwisata.
                            Ini bertujuan untuk menciptakan pengalaman wisata yang berkelanjutan dan berdampak positif
                            bagi
