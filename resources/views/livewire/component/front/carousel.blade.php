    ...
    <div class="carousel relative shadow-2xl bg-white ">
        <div class="carousel-inner relative overflow-hidden w-full ">
            ...
            @foreach ($carousels as $item => $carousel)
                ...
                <input class="hidden carousel-open" type="radio" id="carousel-{{$index}}" name="carousel" aria-hidden="true"
                ...
                <div class="carousel-item absolute opacity-0">
                    <div class="grid grid-rows-2 md:grid-cols-2 text-white text-5xl text-center ">
                        <div class=" flex-col p-6 md:justify-center items-center flex" data-aos="fade-up"
                            ...
                            <p class="text-4xl md:text-5xl md:mb-4 md:mt-4 text-yellow-300 font-lobster">{{$carousel['heading_lg']}}
                            </p>
                        ...
                        <div class="">
                            <img src="{{ Storage::disk('carousel')->url($carousel['bgimage']) }}" alt="" srcset=""
