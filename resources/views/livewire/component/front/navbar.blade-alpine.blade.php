    ...
    <nav class="bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-900 fixed z-50 w-full shadow-md">
        <div class="flex flex-wrap items-center mx-auto max-w-screen-xl pt-4 pl-4 pr-4 w-full">
            ...
            <a href="https://www.teknik.warmadewa.ac.id/" class="flex items-center ">
                ...
                <span
                    class="self-center sm:text-base md:text-lg font-semibold whitespace-nowrap dark:text-white ">Fakultas Teknik dan Perencanaan
                    <span
                        class="flex self-center text-sm whitespace-nowrap dark:text-white ">Universitas Warmadewa
                    </span>
                </span>
            </a>
            ...
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl py-4 w-full">
                <div id="mega-menu-full-image"
                    ...
                    <ul class="flex flex-col mt-4 font-medium md:flex-row md:space-x-8 md:mt-0">
                        <template x-data='{navbars : @json($navbar)}' x-for='navbar in navbars'>
                            <x-front.nav-item x-data="navbar" />
                        </template>
                    </ul>
                </div>
            </div>
        ...
        <template x-data='{navbars : @json($navbar)}' x-for='navbar in navbars'>
            <x-front.nav-mega-menu-dropdown
                x-data="navbar" />
        </template>
    </nav>
</div>
