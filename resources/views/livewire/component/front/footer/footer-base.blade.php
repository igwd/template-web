    ...
    <footer class="bg-white dark:bg-gray-900">
        <div class="mx-auto w-full max-w-screen-xl">
            <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Fakultas Teknik dan
                        Perencanaan Universitas Warmadewa</h2>
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <a href="#" class=" hover:underline">Alamat: Jl. Terompong 24 Tanjung Bungkak Denpasar
                                Bali, Indonesia</a>
                        </li>
                        <li class="mb-4">
                            <a href="#" class="hover:underline">Telepon: 0361-223858</a>
                        </li>
                        <li class="mb-4">
                            <a href="mailto:ftpwarmadewa@gmail.com" class="hover:underline">Email:
                                ftpwarmadewa@gmail.com</a>
                        </li>
                ...
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <a href="#" class="hover:underline">User Online : 1</a>
                        </li>
                        <li class="mb-4">
                            <a href="#" class="hover:underline">Today Visitor : 67</a>
                        </li>
                        <li class="mb-4">
                            <a href="#" class="hover:underline">Hits hari ini : 92</a>
                        </li>
                        <li class="mb-4">
                            <a href="#" class="hover:underline">Total pengunjung : 17021</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        ...
                        <li class="mb-4">
                            <a href="https://www.instagram.com/teknikwarmadewa"
                                class="hover:underline flex items-center gap-2">
                                Instagram
                                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="mb-4">
                            <a href="https://www.facebook.com/teknikwarmadewa"
                                class="hover:underline flex items-center gap-2">
                                Facebook
                        ...
                        <li class="mb-4">
                            <a href="https://www.youtube.com/channel/UC4fmlLXn_f7eMxmmqJURmlA"
                                class="hover:underline flex items-center gap-2">
                                Youtube
